                    ...
                    hydration ? <div className='pt-10 pb-14  '>
                        ...
                        <div className="grid grid-cols-6 m-4 gap-4 ">
                            ...
                            <div className='col-span-6'>
                                ...
                                <Charts current={amounts} last={amountslast} text={"Earnings Comparison in Current Month  and Last Month"} size='2xl'  x='Current Month' y='Last Month'/>
                            </div>

                            {codeRepetition(<TinyBarChart current={revenue} last={expenses} text='Comparison between Revenue and Expenses for Current month' />)}
                            {codeRepetition(<Charts current={revenueLast} last={expensesLast} text=' Comparison between Revenue and Expenses for Last month' size='base' x='Revenue' y='Expenses'/>)}

                            <div className='col-span-6'>
                                <TopOrder count={itemCounts} text=" Top Orders (% in Sales)" size='2xl'/>
                            </div>
