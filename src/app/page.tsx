...
export default function Home() {
  return (
             <div className=" min-h-screen relative flex flex-col items-center justify-center gap-y-20 overflow-hidden bg-body">
             <div className="w-full h-full absolute pattern opacity-[0.03]"></div>
             <Image src="/Images/logo.png"  className="relative z-1 floating" alt="pizza world" width={340} height={340}/>
