...

      {
        hydration ? <div className='py-10 relative bg-gradient-to-t to-mainRed from-main_orange min-h-screen '>
          <div className='text-main'>
            ...
            <Link href={"/home"}>
          <div className='bg-gradient-to-t to-mainRed from-main_orange  text-body flex  items-center fixed px-2 py-2  rounded-full left-24 gap-x-1 group'>
          ...
          <div className=' mx-4  lg:mx-auto lg:w-1/2  rounded-pixel py-2 px-4 lg:px-8  relative  z-1 bg-main_orange  mBlur Gborder '>
            {
