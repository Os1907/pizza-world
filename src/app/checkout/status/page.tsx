...
export default function Status() {
  ...
  return (
    <>
    {
      orderStatus[0]?.status  === "Pending" ? <div className='relative lg:min-h-screen w-1/2 mx-auto flex items-center justify-center'>
         <Link href={"/home"}>
        ...
        <div className='mBlur Gborder w-full mt-10  flex flex-col items-center justify-center  rounded-pixel bg-light py-4'>
