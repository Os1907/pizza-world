...
const dispatch = useDispatch()
    ...
    return (
        <>
                ...
                <div className='my-3 flex flex-col items-center min-h-sc borderGlass w-full  mx-auto rounded-pixel p-4'>
                    ...
                    <form onSubmit={submitForm} className='flex justify-start items-center w-full  flex-wrap bg-transparent'>
                        ...
                        <input id='cName' type="text" className='bg-blury mBlur Gborder rounded-pixel text-lg font-semibold text-body px-3 py-1 focus:outline-0  w-full  active:bg-transparent' />
                        
                        
                        <label htmlFor="cNumber" className='text-body font-bold      px-3 py-1 rounded-pixel '>
                            Phone number
                        </label>
                        <input id='cNumber' type="text" className='bg-blury mBlur Gborder rounded-pixel text-lg font-semibold text-body px-3 py-1 focus:outline-0  w-full ' />
                        <label htmlFor="cAddress" className='text-body font-bold      px-3 py-1 rounded-pixel '>
                        Address
                        </label>
                        <input id='cAddress' type="text" className='bg-blury mBlur Gborder rounded-pixel text-lg font-semibold text-body px-3 py-1 focus:outline-0  w-full ' />
